  ...
  function validateStep(step: number): boolean {
    ...
    switch (step) {
      ...
      case 2:
        ...
        break;
      case 3:
        // Contact info is pre-filled from user account, but still validate
...
<div class="user-report-form">
  ...
  <div class="steps-container">
    <div class="steps-header">
      ...
      <div class="user-badge">
        ...
        <span>Logged in as {formData.reporterName}</span>
      </div>
    </div>
  ...
  <div class="form-content">
    ...
    <!-- Step 3: Contact Information (Pre-filled from account) -->
    {#if currentStep === 3}
      <div class="step-content">
        <div class="step-header">
        ...
        <div class="account-info-notice">
          ...
          <p>Your contact information is automatically filled from your account profile. You can update your phone number below.</p>
        </div>
        ...
        <div class="form-fields">
          <div class="field-group">
            <label for="reporterName" class="field-label">
              ...
              Your Name *
              <span class="auto-filled">From your account</span>
            </label>
            <input
              type="text"
              id="reporterName"
              bind:value={formData.reporterName}
              class="field-input readonly {errors.reporterName ? 'error' : ''}"
              readonly
            />
          ...
          <div class="field-group">
            ...
            <input
              ...
              class="field-input readonly {errors.reporterEmail ? 'error' : ''}"
              readonly
            />
...
<style>
  ...
  .account-info-notice .material-icons {
    font-size: 20px;
    margin-right: 0.75rem;
    color: #319795;
  }

  .account-info-notice p {
    margin: 0;
    font-size: 0.875rem;
  }
